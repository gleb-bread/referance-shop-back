...
class User extends Model {
	...
	public $user_mid;
	public $user_sip;
	public $user_manager_status;
	public $user_admin;
	public $user_api_secret;
	public $user_tlgrm;
	public $user_tlgrm_id;
	public $user_login;
	public $user_phone;
	public $user_email;
	...
	public $user_photo;
	public $user_fio;
	public $user_pay_finish;
	public $user_pay_shp_item;
	public $user_pay_shp_name;
	public $user_ref_invite;
	public $user_ref_code;
	public $user_ref_visits;
	public $user_ref_card;
	public $user_focus_command;
	public $user_zadarma_key;
	public $user_zadarma_secret;
	...
	// can't create a new user in this class!
	...
	public static function __init__() {
		...
		self::$numbers_fields = [
			'user_id','user_mid','user_sip','user_manager_status',
			'user_admin','user_tlgrm_id','user_pay_shp_item',
			'user_ref_visits','current_department_id',
		];
